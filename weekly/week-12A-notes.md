...
1. Which of the following client applications could at times be required to parse JSON? i) *Android or iOS Native Weather App*, ii) *Node Console App that uses `request`*, iii) *Web Browser Ajax App*
1. Which of the following client applications could at times be required to parse JSON-P? i) *Android or iOS Native Weather App*, ii) *Node Console App that uses `request`*, iii) *Web Browser Ajax App*
