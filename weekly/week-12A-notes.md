...
1. Which of the following client applications could at times be required to parse JSON? *Android or iOS Weather App*, *Node Console App*, *Web Browser*
1. Which of the following client applications could at times be required to parse JSON-P? *Android or iOS Weather App*, *Node Console App*, *Web Browser*
