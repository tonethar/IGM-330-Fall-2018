...
1. Which of the following client applications will at times be required to parse JSON? *Android or iOS App*, *Node Console App*, *Web Browser*
1. Which of the following client applications will at times be required to parse JSON-P? *Android or iOS App*, *Node Console App*, *Web Browser*
