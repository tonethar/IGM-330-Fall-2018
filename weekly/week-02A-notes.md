...
\*\* ***But flipping the order of the stroke and fill calls, in this case calling `ctx.stroke()` AFTER `ctx.fill()`, WILL change how the drawing looks. Below we can see the entire 10-pixels of the stroke.*** \*\*
